...
<<<<<<<HEAD private final JPanel contentPanel=new JPanel();private JTextField textVGestion;private VIniciarSesion vInicio=null;private JButton ButtonVolverVGestion;

/**
 * Launch the application.
 */
public static void main(String[]args){try{VGestion dialog=new VGestion();dialog.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);dialog.setVisible(true);}catch(Exception e){e.printStackTrace();}}
/**
 * Create the dialog.
 * @param b 
 * @param vPrincipal 
 */
public VGestion(VIniciarSesion vInicio,boolean modal){super(vInicio);

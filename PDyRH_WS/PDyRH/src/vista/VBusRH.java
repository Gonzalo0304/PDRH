...
public class VBusRH extends JDialog {
	...
	public VBusRH() {
		...
		buttonVolver = new Button("Volver");
		buttonVolver.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				volver();
			}
		});
		buttonVolver.setFont(new Font("Tahoma", Font.BOLD, 12));
		buttonVolver.setForeground(Color.WHITE);
		buttonVolver.setBackground(new Color(153, 0, 0));
		buttonVolver.setBounds(328, 359, 107, 31);
	...
	public VBusRH(VPrincipal vMain, boolean modal, RestoHumano restoHumano, ContDatosBusq datos) {
		...
		if(restoHumano!=null) {
			...
			identificado(persona, restoHumano, datos);
		}
		
		
	}
	
	private void identificado(Persona persona, RestoHumano restoHumano, ContDatosBusq datos) {
		// TODO Auto-generated method stub
		persona = new Persona();
		persona = datos.buscarIdentificado(restoHumano.getCodResto());
